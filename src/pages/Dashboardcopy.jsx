          ...
          <div className="  grid grid-cols-4 w-full h-full gap-5">
              ...
              <Card className="bg-[#FFFFFF] flex flex-col w-full py-4 h-full ">
                <div className="flex justify-between px-2 mx-4 mb-3 py-1">
                  ...
                  <div className="flex gap-3">
                    <div>
                      <button className="bg-[#F89320] text-white p-2 rounded-xl">
                        <FontAwesomeIcon
                          className="px-1"
                          icon={faPenToSquare}
                        />
            ...
            <div className="grid grid-cols-2 w-full h-full lg:col-span-1 col-span-4 gap-5">
              <Card className="bg-[#FFFFFF] flex flex-col col-span-1 lg:col-span-2 relative">
                <FontAwesomeIcon
                  className="absolute p-4 text-2xl rounded-2xl top-5 right-5 bg-[#B2FFCC] text-[#29B659]"
                  icon={faLineChart}
                />
              ...
              <Card className="bg-[#FFFFFF] flex flex-col relative col-span-1 lg:col-span-2">
                <CardContent className="p-5 mt-auto">
                  <FontAwesomeIcon
                    className="absolute p-4 top-5 text-2xl rounded-2xl right-5 bg-[#FFF2B2] text-[#FFD400]"
                    icon={faUserTie}
                  />
                  <div className="">
                    <p className="font-['Montserrat',Helvetica] font-normal text-black text-xl">
          ...
          <div className="grid grid-cols-4  w-full h-full gap-5">
            ...
            <div className="grid grid-cols-2 w-full h-full lg:col-span-1 col-span-4 gap-5 ">
              ...
              <Card className="bg-[#FFFFFF] flex flex-col col-span-1 lg:col-span-2 relative">
                <CardContent className="mt-auto p-5">
                  <FontAwesomeIcon
                    className="absolute p-4 text-2xl rounded-2xl top-5 right-5 bg-[#B5E7FF] text-[#30A7DE]"
                    icon={faWarehouse}
                  />
                  <div className="">
                    <p className="font-['Montserrat',Helvetica] font-normal text-black text-xl">
              ...
              <Card className="bg-[#FFFFFF] flex flex-col relative col-span-1 lg:col-span-2">
                <CardContent className="p-5 mt-auto">
                  <FontAwesomeIcon
                    className="absolute p-4 text-2xl rounded-2xl top-5 right-5 bg-[#FFEAB3] text-[#EDB421]"
                    icon={faTruckFast}
                  />
                  <div className="">
                    <p className="font-['Montserrat',Helvetica] font-normal text-black text-xl">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="relative inline-block">
                      <select
                        ...
                        className="bg-[#F89320] text-white text-sm px-3 py-2 pr-8 rounded-xl hover:bg-orange-300 appearance-none focus:outline-none"
                      >
                      ...
                      <div className="pointer-events-none absolute inset-y-0 right-0 flex inset-x-0 text-white">
                        <FontAwesomeIcon className="bg-amber-400" icon={faAngleDown} />
                      </div>
                    </div>
                  </div>
                </div>
